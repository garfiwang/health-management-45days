...
> 本文件整合《減重飲食守則》、《八戒原則》與《第七周參考菜單》，為 Rich 與 Carolyn 健管 45 天計畫第七週（結案衝刺與體態雕塑期）執行規範。
> 
> 🔥 **第七週核心亮點（高代謝維持＋精準燃脂收尾）**：
> 本週採 **3 天新陳代謝日（星期四、五、六）＋ 4 天蛋白日（星期日、一、二、三）** 節奏。前三天藉由 **80g 原型優質穀物**（糙米/五穀飯）與加量優質肉類（**3~4 兩，112.5~150g**）、生蔬菜不限量來維持高基礎代謝與飽滿肌醣；後四天接續純蛋白日進行深度去水腫與體脂最後衝刺，完美迎接 45 天計畫結案成果！
...
### 2. 澱粉與穀物控制
- **新陳代謝日（週四～週六）**：三餐皆可進食優質五穀類（糙米飯、五穀米飯，每餐熟重 80g，約平平半碗 / 半拳頭份量）。
- **蛋白日（週日～週三）**：完全不吃澱粉與穀物類，回歸純蛋白質充填與深度排水燃脂。
...
## 📅 三、第七週參考菜單（7 天結構：3 新陳代謝日 + 4 蛋白日）

```mermaid
graph LR
    A["週四~週六 (3天)<br>新陳代謝日 (充填肌醣/開代謝)"] --> B["週日~週三 (4天)<br>蛋白日 (深度去水腫/燃脂衝刺)"]
...
> 註：下表提供「單人每日攝取量」、「單人第七週（7天）總需求」與「雙人（Rich + Carolyn）第七週總備貨需求」，方便進行備貨與日常分裝。

| 營養素 / 補充品品名 | 每次補充份量 | 每日補充時段 | 每日單人份數 | **單人第七週總量 (7天)** | **雙人第七週總量 (Rich+Carolyn)** | 主要功能與補充目的 |
| :--- | :--- | :--- | :--- | :--- | :--- | :--- |
| **蛋白素 (All Plant Protein)** | 1 匙 / 次 | 08:00, 10:00, 12:00, 14:00, 16:00, 18:00, 20:00 | 6 ～ 7 匙 | **42 ～ 49 匙** | **84 ～ 98 匙** | 提供優質植物蛋白、維持肌肉量、抗飢餓 |
